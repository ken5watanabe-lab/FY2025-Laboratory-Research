...
def classify(filepaths, destination):
    ...
    for i in jobs:
        ...
        if os.path.exists(f"/home/data/sleepStateExperiment_from_video/sleepEnsOutput/{Path(filepaths[i]).stem}-predictions.fif"):
            continue
...
def main(eeg_type, emg_reverse=False):
    ...
    model_path = "/home/jupyter/sleepState_from_video/python/sleepens/joblib/SleepEnsemble4_1.0.1_male-py3.7.8-win32-64bit.joblib"  # TODO: change file name
